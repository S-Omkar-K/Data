...
As we have only one wave of daya and no repeated observations, we run Regression of Interest,, design with an Instrument Variable.
...
I would send the Utility 2 estimates to CALBEARS as final results.
